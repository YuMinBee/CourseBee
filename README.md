...
| 5분 UI 실측 | 목표 길이 보장 없음 | Qwen 원본 `1,736자` -> 최종 `1,892자`, 19개 대화 구간, estimator 기준 약 5분 15초 |
| 장문 로컬 실험 | 기본 오디오 경로는 `2,000자` 상한 | `6,000자` 목표에서 대본 `5,164자`, 실제 발화 `4,957자`, Edge TTS 약 10분 45초 |
